#!/usr/bin/env python3
"""
使用 Claude Sonnet 模型自动翻译 zh/ 目录下的所有 MDX 文件
需要安装: pip install anthropic
设置环境变量: export ANTHROPIC_API_KEY="your-api-key"
"""
...
class SonnetTranslator:
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not api_key:
            raise ValueError("请设置 ANTHROPIC_API_KEY 环境变量或提供 API 密钥")
...
{content}"""
    ...
    def translate_all(self):
        """翻译所有文件"""
        print("🚀 开始使用 Claude Sonnet 翻译 zh/ 目录下的 MDX 文件")
        print("=" * 60)
